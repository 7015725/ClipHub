/* ClipHub adaptive-width and rapid-close test entry. Rhino ES5 only. */
(function (global) {
    ...
    var TEST_MANIFEST_PATH = "module-manifest-adaptive-width.json";
    ...
    function fetchEntry() {
        ...
        try {
            ...
            connection.setRequestProperty(
                "User-Agent", "ClipHub-AdaptiveWidth-Test/7");
    ...
    function main() {
        ...
        return {
            ...
            project: "ClipHub",
            testEntry: "adaptive_width",
            testEntryVersion: TEST_ENTRY_VERSION,
            sourceRef: REF,
            manifestPath: TEST_MANIFEST_PATH,
            expectedModuleSetVersion: "20260806.03",
            rapidCloseFixExpected: true,
            adaptiveWidthFixExpected: true,
            bootstrap: bootstrapResult
        };
    }

    try {
        global.ClipHubAdaptiveWidthTestEntryResult = main();
    } catch (error) {
        global.ClipHubAdaptiveWidthTestEntryResult = {
            ok: false,
            project: "ClipHub",
            testEntry: "adaptive_width",
            testEntryVersion: TEST_ENTRY_VERSION,
...
JSON.stringify(ClipHubAdaptiveWidthTestEntryResult);
