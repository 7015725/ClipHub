/* ClipHub new home UI probe 033 loader. Rhino ES5 only. */
(function (global) {
    ...
    var target = "https://raw.githubusercontent.com/7015725/ClipHub/" +
        ...
        "cliphub_new_home_ui_probe_033_impl.js" +
    ...
    try {
        ...
        if (source.indexOf("probeVersion: 1") < 0 ||
                source.indexOf("REQUIRED_SET = \"20260722.26\"") < 0 ||
                source.indexOf("themeModuleVersion === 2") < 0 ||
                source.indexOf("windowModuleVersion === 5") < 0 ||
                source.indexOf("listModuleVersion === 10") < 0 ||
                source.indexOf("cliphub_new_home_ui_probe_033") < 0) {
