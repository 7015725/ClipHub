/* ClipHub search and advanced filter visual probe 037. Rhino ES5 only. */
(function (global) {
    ...
    var REQUIRED_SET = "20260722.30";
    var RUNTIME_NAME = "ClipHubProbe037";
    ...
    function add(content, contentType, sourcePackage, sourceLabel,
        ...
        return Number(global.ClipHub.Repository.insertItem({
            ...
            sourcePackage: String(sourcePackage || "com.cliphub.probe037"),
    ...
    function main() {
        ...
        var outputFile = new File(ensureDir(new File(formal, "probes")),
            "cliphub_search_filter_ui_probe_037_" +
        ...
        var result = {
            ok: false,
            probe: "cliphub_search_filter_ui_probe_037",
            probeVersion: 1,
        ...
        try {
            ...
            result.searchReady = waitFor(function () {
                ...
                return current.active === true &&
                    ...
                    current.panel.searchPageStyle === "reference_search_v3" &&
            ...
            showToast("037  1/2  搜索结果页  ·  请截完整页面");
            ...
            showToast("037  2/2  高级筛选抽屉  ·  请截完整页面");
            Thread.sleep(SCENE_DURATION_MS);

            result.advancedBack = global.ClipHub.Navigation
                .dispatchBackForOwner("filter", "probe_advanced_back_037");
            ...
            result.searchBack = global.ClipHub.Navigation
                .dispatchBackForOwner("filter", "probe_search_back_037");
    ...
    try {
        global.ClipHubSearchFilterUiProbe037Result = main();
    } catch (error) {
        global.ClipHubSearchFilterUiProbe037Result = {
            ok: false,
            probe: "cliphub_search_filter_ui_probe_037",
            probeVersion: 1,
            fatal: true,
