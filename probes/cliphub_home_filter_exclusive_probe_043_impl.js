/* ClipHub home and filter exclusive-window probe 043. Rhino ES5 only. */
(function (global) {
    ...
    var REQUIRED_SET = "20260722.36";
    var RUNTIME_NAME = "ClipHubProbe043";
    ...
    function add(content, contentType, sourcePackage, sourceLabel,
        ...
        return Number(global.ClipHub.Repository.insertItem({
            ...
            sourcePackage: String(sourcePackage || "com.cliphub.probe043"),
    ...
    try {
        global.ClipHubHomeFilterExclusiveProbe043Result = main();
    } catch (error) {
        global.ClipHubHomeFilterExclusiveProbe043Result = {
            ok: false,
            probe: "cliphub_home_filter_exclusive_probe_043",
            probeVersion: 1,
            fatal: true,
