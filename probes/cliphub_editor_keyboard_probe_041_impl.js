/* ClipHub editor keyboard and long-text probe 041. Rhino ES5 only. */
(function (global) {
    ...
    var REQUIRED_SET = "20260722.34";
    var RUNTIME_NAME = "ClipHubProbe041";
    ...
    function add(content, contentType, sourcePackage, sourceLabel,
        ...
        return Number(global.ClipHub.Repository.insertItem({
            ...
            sourcePackage: String(sourcePackage || "com.cliphub.probe041"),
    ...
    function main() {
        ...
        var outputFile = new File(ensureDir(new File(formal, "probes")),
            "cliphub_editor_keyboard_probe_041_" + stamp(startedAt) + ".json");
        ...
        var result = {
            ok: false,
            probe: "cliphub_editor_keyboard_probe_041",
            probeVersion: 1,
        ...
        try {
            ...
            if (!waitFor(function () {
                    ...
                    return current.attachedToWindow === true &&
                        current.editorStyle === "reference_editor_v3" &&
            ...
            showToast("041  1/3  输入法已弹出  ·  请截完整页面");
            ...
            showToast("041  2/3  长文本末尾  ·  请截完整页面");
            Thread.sleep(SCENE_DURATION_MS);
            ...
            showToast("041  3/3  首次返回仅收起键盘  ·  请截完整页面");
            Thread.sleep(SCENE_DURATION_MS);
            ...
            result.stop = global.ClipHub.App.stop("probe041_editor_keyboard");
            result.databaseClosed = !global.ClipHub.Database.isOpen();
            result.lockReleased = lockFree(isolated);
        } catch (error) {
            result.error = errorText(error);
            try { global.ClipHub.App.stop("probe041_error"); }
            catch (ignoredStop) {}
        } finally {
            try {
                if (formalWasRunning) {
            ...
            result.ok = result.error === null &&
                ...
                result.keyboardScene.editorStyle === "reference_editor_v3" &&
    ...
    try {
        global.ClipHubEditorKeyboardProbe041Result = main();
    } catch (error) {
        global.ClipHubEditorKeyboardProbe041Result = {
            ok: false,
            probe: "cliphub_editor_keyboard_probe_041",
            probeVersion: 1,
            fatal: true,
