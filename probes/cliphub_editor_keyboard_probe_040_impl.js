...
(function (global) {
    ...
    var REQUIRED_SET = "20260722.33";
    var RUNTIME_NAME = "ClipHubProbe040";
    ...
    function add(content, contentType, sourcePackage, sourceLabel,
        ...
        return Number(global.ClipHub.Repository.insertItem({
            ...
            sourcePackage: String(sourcePackage || "com.cliphub.probe040"),
    ...
    try {
        global.ClipHubEditorKeyboardProbe040Result = main();
    } catch (error) {
