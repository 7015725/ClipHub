/* ClipHub system navigation and background-hide probe 030 implementation. Rhino ES5 only. */
(function (global) {
    ...
    function main() {
        ...
        try {
            ...
            result.navigationPresent = !!global.ClipHub.Navigation;
            ...
            result.ok = result.navigationPresent &&
                ...
                result.detailClosedAfterBack &&
                result.homeRemainedAfterDetailBack &&
                result.editorOpen && result.editorBackHandled &&
                result.editorClosedAfterBack &&
