...
(function (global) {
    ...
    try {
        ...
        connection.setRequestProperty("User-Agent", "ClipHub-Probe/040-v1");
        ...
        if (!source) {
            throw new Error("Probe 040 implementation is empty");
        }
        if (source.indexOf("probeVersion: 1") < 0 ||
            ...
            throw new Error("Probe 040 implementation validation failed");
        }
        eval(source + "\n//# sourceURL=ClipHub/probe_040_impl_v1.js");
    } finally {
...
JSON.stringify(ClipHubEditorKeyboardProbe040Result);
